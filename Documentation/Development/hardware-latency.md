...
Open **Settings** from the header (**SETTINGS** button) and adjust **HARDWARE LATENCY :** (0.0–200.0 ms, 0.1 ms steps). The value is saved in the plugin session state and restored with your project.
