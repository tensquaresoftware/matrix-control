...
public:
    ...
    static int getWidth() { return PluginDimensions::Panels::PatchManagerPanel::PatchMutatorPanel::kWidth; }
    static int getHeight() { return PluginDimensions::Panels::PatchManagerPanel::PatchMutatorPanel::kHeight; }
